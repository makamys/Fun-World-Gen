...
public class ChunkGeneratorSkyDimension implements IChunkProvider
{
    private Random rand;
    ...
    public ChunkGeneratorSkyDimension(World world, long l, boolean par4, int worldID, int noiseStyle)
    {
    ...
    {
        ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(this, i, j, blocks, metadata, abiomegenbase, worldObj);
